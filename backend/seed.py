...
# Place this file in: backend/seed.py
...
# ============================================================================
# CONFIGURATION - Connect to Render Database
# ============================================================================

# Override the database URL to use your Render database
import os
from sqlalchemy import create_engine
from sqlalchemy.orm import sessionmaker

# Your Render database connection string
RENDER_DATABASE_URL = "postgresql://postgress:sEWJ8Z2f330yAoeh6oajypYXekaWnuUP@dpg-d4j229p5pdvs7394d63g-a.oregon-postgres.render.com/sleeping_bear_rental"

# Create engine for Render database
render_engine = create_engine(RENDER_DATABASE_URL)

# Create session for Render database
RenderSession = sessionmaker(autocommit=False, autoflush=False, bind=render_engine)

# Create all tables on Render database
...
print("   Admin:    superadmin@sleepingbear.com / admin123")
