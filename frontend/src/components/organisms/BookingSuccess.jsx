...
const BookingSuccess = ({ onDownload, onHome }) => {
  return (
    <div className="bg-white dark:bg-gray-900 rounded-[30px] shadow-xl p-10 md:p-16 max-w-3xl mx-auto mt-8 text-center border-t-8 border-[#009900] dark:border-[#009900]">
